...
public final class MobSpawnControllerFabric implements ModInitializer {
    ...
    private static void registerPayloads() {
        ...
        PayloadTypeRegistry.playC2S().register(ServerboundSetActiveSpawnPayload.TYPE,
        ...
        ServerPlayNetworking.registerGlobalReceiver(ServerboundSetActiveSpawnPayload.TYPE,
                (payload, context) -> context.server().execute(() ->
                        ServerboundSetActiveSpawnPayload.handle(payload, context.player())));
